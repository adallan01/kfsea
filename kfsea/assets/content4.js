...
PAGES['home'] = {
  ...
  ${story({
    ...
    alt:'Industrial cutting machinery on a factory floor',
  ...
  <section class="section">
    <div class="wrap">
      ...
      <div class="grid g3 tilt-wrap">
        ...
        ${product({img:IMG.rangeGroup,fill:true,h:'Mobile Trolley Units',p:'High capacity wheeled extinguishers for large open risks where a portable will not cover the area.',chips:['Wheeled'],app:'Factories, yards, fuel bays',order:'Mobile Trolley Extinguisher',over:'For large open risks'})}
