...
const CATALOGUE = [
  ...
  {cat:'detection', img:IMG.detectorHead,fill:true, h:'Heat Detectors', p:'For kitchens, plant rooms and dusty areas where smoke detection would false alarm.', app:'Kitchens, plant rooms, workshops', over:'Avoids nuisance alarms'},
  {cat:'detection', img:IMG.panelHand,fill:true, h:'Conventional Alarm Panels', p:'Zoned control panels for smaller and simpler buildings.', chips:['BS 5839'], app:'Small offices, clinics, apartments', over:'Zone level identification'},
  {cat:'detection', img:IMG.alarmWall,fill:true, h:'Addressable Alarm Panels', p:'Device level identification and event logging for larger sites and campuses.', chips:['BS 5839','BAFE SP203'], app:'Schools, hospitals, campuses', over:'Names the exact device in alarm'},
  ...
  {cat:'safety', img:IMG.handling,fill:true, h:'Personal Protective Equipment', p:'Protective equipment to accompany safety provision on site.', app:'Workshops, factories, plant rooms', over:'Specification confirmed on enquiry'},
