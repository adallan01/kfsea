...
const CATS = [
 {
  ...
  items:[
    {art:()=>G.svgExtinguisher('powder'),h:'ABC Dry Powder',p:'General purpose cover rated for Class A, B and C risks. The default choice for corridors, classrooms and vehicles.',chips:['KEBS certified','Refillable'],app:'Offices, schools, corridors, vehicles',over:'Class A, B and C'},
    ...
    {art:()=>G.svgExtinguisher('water'),h:'Water and Water Mist',p:'Cools burning solids. Mist variants reduce the risk around electrical equipment.',chips:['KEBS certified'],app:'Stores, dormitories, paper and textile risks',over:'Class A'},
    {img:IMG.rangeGroup,fill:true,h:'Mobile Trolley Units',p:'High capacity wheeled units for large open risks where a portable will not cover the area.',chips:['KEBS certified','Wheeled'],app:'Factories, yards, fuel bays',over:'Large open risks'},
 ...
 },
 {
  ...
  hero:{art:()=>G.svgPanel('addressable')},
  ...
  items:[
    ...
    {art:()=>G.svgSounder(),h:'Sounders and Strobes',p:'Audible and visual warning devices sized to the building so the warning reaches every occupied space.',chips:['BS 5839'],app:'All system types',over:'Audibility matters'},
 ...
 },
 {
  ...
  items:[
    {art:()=>G.svgEmergencyLight(),h:'Emergency Luminaires',p:'Twin spot and bulkhead luminaires that light the escape route on mains failure.',chips:['OSHA / NEMA','LED'],app:'Stairwells, corridors, plant rooms',over:'Tested on a schedule'},
    {art:()=>G.svgSign('exit'),h:'Maintained Exit Lights',p:'Illuminated exit signage that stays lit in normal use and continues on battery.',chips:['LED'],app:'Final exits, lobbies',over:'Lit at all times'},
    {art:()=>G.svgSign('exit'),h:'Directional Signage',p:'Route marking that keeps people moving in the right direction when visibility drops.',chips:['Photoluminescent'],app:'Corridors, stairwells',over:'Readable without power'}
  ],
 ...
 },
 {
  ...
  items:[
    {art:()=>G.svgBlanket(),h:'Kitchen Fire Blanket',p:'Mounted within reach of the range so it can be used in the first seconds of a pan fire.',chips:['1m x 1m'],app:'Kitchens, canteens, restaurants',over:'Class F risks'},
    {art:()=>G.svgBlanket(),h:'Laboratory Fire Blanket',p:'Larger format for laboratories and workshops where clothing ignition is a credible risk.',chips:['1.8m x 1.8m'],app:'Laboratories, workshops, schools',over:'Clothing fires'},
 ...
 },
 {
  ...
  items:[
    {art:()=>G.svgSign('exit'),h:'Fire Exit Signs',p:'Final exit and route signage that stays readable when the lights are out.',chips:['Photoluminescent'],app:'All building types',over:'Readable without power'},
    {art:()=>G.svgSign('extinguisher'),h:'Fire Point Signs',p:'Marks extinguisher and fire point locations so they can be found by someone who has never looked before.',chips:['Photoluminescent'],app:'Corridors, workshops, kitchens',over:'Makes equipment findable'},
    {art:()=>G.svgSign('assembly'),h:'Assembly Point Signs',p:'Defines where people gather after evacuation, which is what turns a drill into a roll call.',app:'Car parks, fields, courtyards',over:'Supports the roll call'},
 ...
 },
 {
  ...
  hero:{art:()=>G.svgCctv('bullet')},
  facts:[['Resolution','HD'],['Night vision','Yes'],
         ['Remote access','Mobile app viewing'],
         ['Coverage','Indoor and outdoor cameras']],
  items:[
    {art:()=>G.svgCctv('bullet'),h:'Bullet Cameras',p:'Directional outdoor coverage for perimeters, entrances, yards and car parks.',chips:['HD','Night vision'],app:'Perimeters, entrances, yards',over:'Weather rated'},
    {art:()=>G.svgCctv('dome'),h:'Dome Cameras',p:'Discreet internal coverage for receptions, corridors and retail floors.',chips:['HD','Indoor'],app:'Receptions, classrooms, shop floors',over:'Vandal resistant'},
 ...
 },
 {
  ...
  items:[
    ...
    {art:()=>G.svgIntruder('siren'),h:'External Sirens and Strobes',p:'Boundary alerting with sounder, strobe and tamper protection.',app:'Building perimeters',over:'Tamper protected'},
 ...
 },
 {
  ...
  hero:{art:()=>G.svgAccess('biometric')},
  ...
  items:[
    ...
    {art:()=>G.svgAccess('biometric'),h:'Biometric Readers',p:'Fingerprint credentials for areas where a card that can be lent or lost is not good enough.',chips:['Biometric'],app:'Server rooms, cash offices',over:'Fingerprint enrolment'},
