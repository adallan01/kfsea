...
const CATS = [
 {
  ...
  items:[
    ...
    {img:IMG.extWater,h:'Water',p:'Cools burning solids and soaks them so they do not reignite. The straightforward choice where the risk is paper, timber or textiles.',chips:['KEBS certified','Refillable'],app:'Stores, dormitories, classrooms',over:'Class A'},
    {img:IMG.extMist,h:'Water Mist',p:'A fine mist that cools without soaking, and is safe to use near live electrical equipment.',chips:['KEBS certified'],app:'Offices, server rooms, laboratories',over:'Safe near electrics'},
 ...
 },
 {
  ...
  items:[
    {img:IMG.panelHand,fill:true,h:'Conventional Panels',p:'Zoned control panels for smaller and simpler buildings, where a zone identifies the area in alarm.',chips:['BS 5839'],app:'Small offices, clinics, apartments',over:'Zone level identification'},
    {img:IMG.alarmWall,fill:true,h:'Addressable Panels',p:'Device level identification and event logging, so the panel names the exact device in alarm.',chips:['BS 5839','BAFE SP203'],app:'Schools, hospitals, campuses',over:'Names the exact device'},
    {img:IMG.detectorHead,fill:true,h:'Wireless Systems',p:'Quick to install with no wiring damage, for heritage buildings and sites that cannot close for cabling.',chips:['BS 5839'],app:'Occupied and heritage buildings',over:'No chasing walls'},
    ...
    {img:IMG.sounderWall,fill:true,h:'Backup Batteries',p:'Standby power so the system keeps working through the mains failure that a fire often causes.',chips:['BS 5839'],app:'All panels',over:'Replaced on service'}
  ],
 ...
 },
 {
  ...
  items:[
    ...
    {img:IMG.detectorHead,fill:true,h:'Heat Detectors',p:'For kitchens, plant rooms and dusty stores where smoke detection would false alarm.',app:'Kitchens, plant rooms, workshops',over:'Avoids nuisance alarms'},
    {img:IMG.smokeDetector,fill:true,h:'Wireless Detectors',p:'Detection for buildings that cannot be cabled, expandable as the occupancy changes.',chips:['Wireless'],app:'Heritage and occupied buildings',over:'Fast to install'}
  ],
 ...
 },
 {
  ...
  items:[
    ...
    {img:IMG.exitSign,fill:true,h:'Maintained Exit Lights',p:'Illuminated exit signage that stays lit in normal use and continues on battery.',chips:['LED'],app:'Final exits, lobbies',over:'Lit at all times'},
    {img:IMG.exitCorridor,fill:true,h:'Directional Signage',p:'Route marking that keeps people moving in the right direction when visibility drops.',chips:['Photoluminescent'],app:'Corridors, stairwells',over:'Readable without power'}
  ],
 ...
 },
 {
  ...
  items:[
    {img:IMG.intruder,fill:true,h:'PIR Motion Sensors',p:'Internal detection for circulation space, storerooms and cash handling areas.',chips:['PIR'],app:'Offices, warehouses, homes',over:'Works with CCTV'},
    ...
    {img:IMG.intruderPanel,fill:true,h:'Alarm Panels',p:'Arming, disarming, zone configuration and event history for the whole system.',chips:['Network ready'],app:'All installations',over:'Zoned control'}
  ],
 ...
 },
 {
  ...
  items:[
    {img:IMG.accessCard,fill:true,h:'Card and PIN Readers',p:'Everyday access control for offices, stores and server rooms, with an entry record.',chips:['Card','PIN','Network ready'],app:'Offices, stores, server rooms',over:'Tracks staff entry'},
 ...
 },
 {
  ...
  hero:{img:IMG.handling, alt:'Protective gloves and a protective jacket worn while handling fire equipment'},
  ...
  items:[
    ...
    {img:IMG.fireDrill,fill:true,h:'Hand and Body Protection',p:'Supplied on request. Specification confirmed against the task at enquiry.',app:'Workshops, factories, plant rooms',over:'Specified on enquiry'},
    {img:IMG.firstaidWall,fill:true,h:'Site Safety Provision',p:'PPE supplied alongside first aid provision so a site is equipped as a whole.',app:'Workplaces, industrial sites',over:'Pairs with first aid'}
  ],
 ...
 },
 {
  ...
  items:[
    {img:IMG.firstaidWall,h:'Workplace First Aid Kits',p:'Kits sized to the workplace, supplied with the training that makes them useful.',app:'Workplaces, schools, clinics',over:'Pairs with training'},
